    ...
    <header className="h-16 border-b border-[var(--color-border)] bg-[var(--color-surface)] flex items-center justify-between px-6 shrink-0">
      ...
      {user && (
        <div className="flex items-center gap-3">
          <span className="hidden sm:block text-sm text-[var(--color-text-muted)]">{user.email}</span>
          <div className="h-8 w-8 rounded-full bg-[var(--color-brand-subtle)] flex items-center justify-center">
