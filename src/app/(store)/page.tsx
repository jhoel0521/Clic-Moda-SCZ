...
// Quitamos los emojis y usamos fotos reales de ropa
const CATEGORIAS = [
  {
...
export default function LandingPage() {
  return (
    <div className="flex flex-col w-full items-center bg-white">
      ...
      {/* 2. Categorías (Diseño Premium con Fotos) */}
      <section className="w-full bg-white px-6 py-24 flex flex-col items-center">
        <div className="w-full max-w-[1400px]">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link href={ROUTES.CATALOG} className="hidden sm:block text-pink-600 font-bold hover:underline">
              Ver todo el catálogo →
            </Link>
          </div>

          {/* Grilla con imágenes reales */}
          ...
          <Link href={ROUTES.CATALOG} className="mt-8 block text-center sm:hidden text-pink-600 font-bold hover:underline">
            Ver todo el catálogo →
          </Link>
        </div>
      </section>

      {/* 3. ¿Cómo Funciona? (Estilo Limpio) */}
